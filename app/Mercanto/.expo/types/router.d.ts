...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/(auth)` | `/(tabs)` | `/Chat-inbox section` | `/Dashboard` | `/Loginscreen` | `/MapScreen` | `/Profile` | `/SignUp` | `/_sitemap` | `/explore` | `/onboardingscreen` | `/personalProfile` | `/settings`;
