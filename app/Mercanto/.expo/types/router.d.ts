...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/(auth)` | `/(tabs)` | `/(tabs)\SignUp` | `/Chat-inbox section` | `/Dashboard` | `/MapScreen` | `/Profile` | `/SignUp` | `/_sitemap` | `/explore` | `/onboardingscreen` | `/personalProfile` | `/settings`;
