...
const ChatInbox = () => {
  const [conversations, setConversations] = useState([
    ...
    { id: 2, name: 'Rasta', message: 'Meeting tomorrow at 10 AM.', time: '1:30 PM', image: '(link unavailable)', unread: false,
      sent: true },
    ]);
    ...
    const handleDelete = (id) => {
      ...
      setIsModalVisible(false); // Hide modal after delete
    };
        ...
        <ScrollView style={styles.conversationList}>
          {conversations.map((conversation) => (
            <TouchableOpacity
              ...
              onLongPress={() => setIsModalVisible(true)} // Long press to show actions
            >
              <Image
